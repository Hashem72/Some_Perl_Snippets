...
#&write_list_of_alignment_blocks_into_a_file(\@list_of_files_in_directory, $list_of_ali_blocks);
...
sub write_list_of_alignment_blocks_into_a_file($$){
    my $list_of_file_names_ref  = shift;
    my $output_file_name        = shift;
...
}#write_list_of_alignment_blocks_into_a_file#
